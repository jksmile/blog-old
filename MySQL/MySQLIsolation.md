...
*   [隔离级别](#isolationLevel)
*   [实操](#actioin)
    *   [验证读未提交](#verifyReadUncommitted)
    *   [验证读提交](#verifyReadCommitted)
    *   [验证可重复读](#verifyRepeatableRead)
...
<h4 id="verifyReadUncommitted">验证未提交读</h4>
...
<h4 id="verifyReadCommitted">验证提交读</h4>
...
<h4 id="verifyRepeatableRead">验证可重复读</h4>
